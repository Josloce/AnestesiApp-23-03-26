...
export const SCALES: Scale[] = [
  {
    ...
    interpretations: [
      { min: 1, max: 1, text: 'Riesgo mínimo. Paciente sano.', recommendation: 'Proceder con plan anestésico estándar.', color: 'green' },
      { min: 2, max: 2, text: 'Riesgo leve. Enfermedad sistémica controlada.', recommendation: 'Optimización preoperatoria de patologías de base.', color: 'yellow' },
      { min: 3, max: 3, text: 'Riesgo moderado. Limitación funcional.', recommendation: 'Evaluación detallada por especialistas y optimización.', color: 'orange' },
      { min: 4, max: 4, text: 'Riesgo alto. Amenaza vital constante.', recommendation: 'Considerar cuidados intensivos postoperatorios y monitoreo invasivo.', color: 'red' },
      { min: 5, max: 5, text: 'Riesgo extremo. Supervivencia incierta.', recommendation: 'Cirugía de salvamento. Consentimiento informado de alto riesgo.', color: 'red' },
    ]
  },
  {
    id: 'mallampati',
  ...
  },
  {
    ...
    interpretations: [
      { min: 5, max: 6, text: 'Clase A. Enfermedad bien compensada.', recommendation: 'Buen pronóstico quirúrgico. Continuar manejo médico.', color: 'green' },
      { min: 7, max: 9, text: 'Clase B. Compromiso funcional significativo.', recommendation: 'Riesgo quirúrgico moderado. Optimizar función hepática.', color: 'orange' },
      { min: 10, max: 15, text: 'Clase C. Enfermedad descompensada.', recommendation: 'Alto riesgo quirúrgico. Considerar solo procedimientos de emergencia.', color: 'red' },
    ]
  },
  {
    id: 'nyha',
  ...
  },
  {
    ...
    interpretations: [
      { min: 0, max: 25, text: 'Riesgo bajo de complicaciones pulmonares.', recommendation: 'Manejo estándar. Fisioterapia respiratoria básica.', color: 'green' },
      { min: 26, max: 44, text: 'Riesgo intermedio de complicaciones pulmonares.', recommendation: 'Fisioterapia respiratoria intensiva y espirometría de incentivo.', color: 'orange' },
      { min: 45, max: 100, text: 'Riesgo alto de complicaciones pulmonares.', recommendation: 'Considerar CPAP postoperatorio y monitoreo en cuidados intermedios.', color: 'red' },
    ]
  },
  {
    id: 'apfel',
  ...
  },
  {
    ...
    interpretations: [
      { min: 0, max: 1, text: 'Riesgo bajo.', recommendation: 'Deambulación temprana. No requiere profilaxis farmacológica usualmente.', color: 'green' },
      { min: 2, max: 2, text: 'Riesgo moderado.', recommendation: 'Considerar medias de compresión o HBPM según cirugía.', color: 'yellow' },
      { min: 3, max: 4, text: 'Riesgo alto.', recommendation: 'Profilaxis farmacológica con HBPM indicada.', color: 'orange' },
      { min: 5, max: 20, text: 'Riesgo muy alto.', recommendation: 'Profilaxis farmacológica y mecánica combinada.', color: 'red' },
    ]
  },
  {
    id: 'dasi',
